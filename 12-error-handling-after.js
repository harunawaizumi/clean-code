...
function getTransactionProcessor(transaction) {
	...
	if (usesTransactionMethod(transaction, 'CREDIT_CARD')) {
		processors.processPayment = proceeCrediCardPayment;
		processors.processRefund = proceeCrediCardRefund;
	} else if (usesTransactionMethod(transaction, 'PAYPAL')) {
	    processors.processPayment = proceePaypalPayment;
		processors.processRefund = proceePaypalRefund;
	} else if (usesTransactionMethod(transaction, 'PLAN')) {
	    processors.processPayment = proceePlanPayment;
		processors.processRefund = proceePlanRefund;
	}
}
